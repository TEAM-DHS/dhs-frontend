...
const OtherSection = ({ otherPrograms }: EventDetailType) => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-[1160px] laptop:w-[calc(100%-100px)] flex justify-start font-bold text-mdTitle mb-[40px]">
        이런 행사는 어떠신가요?
      </div>
      <div className="w-[1160px] laptop:w-[calc(100%-100px)] flex flex-wrap gap-[30px] pb-[160px] mobile:w-[calc(100%-40px)]">
