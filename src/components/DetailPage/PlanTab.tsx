...
const PlanTab = ({ content, notices, host, tabRef, setTab }: Props) => {
  ...
  return (
    <div className="w-[1160px] laptop:w-[calc(100%-100px)] flex justify-between pb-[50px]">
      <div className="max-w-[600px] flex flex-col gap-[70px]">
      ...
      {notices.length !== 0 && (
        <div className="p-[25px] w-[360px] h-min max-h-[500px] flex flex-col gap-[40px] border-[1px] border-lightGray rounded-[5px] shadow-[0px_2px_3px_0px] shadow-black/10">
          ...
          <div className="flex flex-col gap-[20px]">
            ...
            <div className="font-regular text-black text-smTitle text-center line-clamp-[10]">
